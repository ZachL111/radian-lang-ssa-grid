"""Regression checks for the radian-lang-ssa-grid casebook."""
...
from casebook.harness import assert_expected, radian_lang_ssa_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_lang_ssa_grid_summary(), assert_expected())
