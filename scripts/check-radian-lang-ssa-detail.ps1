...
$repo = "radian-lang-ssa-grid"
$language = "Julia"
$category = "Compilers"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/radian-lang-ssa-walkthrough.md")) {
